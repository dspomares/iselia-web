const translations = {
  es: {
    ...
    'priv-5-p2':        'Con independencia de lo anterior, este sitio web carga dos servicios de terceros: <strong>Cookiebot</strong>, prestado por Cybot A/S (Dinamarca), que gestiona el consentimiento de cookies desde la Unión Europea; y <strong>Google Analytics 4</strong>, prestado por Google Ireland Limited y Google LLC. Al visitar cualquier página, tu dirección IP se comunica a estos proveedores. En el caso de Google, esto puede suponer una <strong>transferencia internacional de datos</strong> a Estados Unidos, amparada en la Decisión de Adecuación del EU-US Data Privacy Framework, en la que Google LLC figura certificada.',
  ...
  en: {
    ...
    'priv-5-p2':        'Independently of the above, this website loads two third-party services: <strong>Cookiebot</strong>, provided by Cybot A/S (Denmark), which manages cookie consent from within the European Union; and <strong>Google Analytics 4</strong>, provided by Google Ireland Limited and Google LLC. When you visit any page, your IP address is communicated to those providers. In the case of Google this may constitute an <strong>international data transfer</strong> to the United States, covered by the Adequacy Decision of the EU-US Data Privacy Framework, under which Google LLC is certified.',
    ...
    'ck-2-p2':          'The site also embeds <strong>Google Analytics 4</strong> (identifier G-BYKG0C7WKZ), loaded directly in the page, to measure in aggregate how the site is browsed. If you accept the <em>Statistics</em> category, it installs the <em>_ga</em> and <em>_ga_BYKG0C7WKZ</em> cookies, which assign a random identifier to your browser, are kept for 2 years and collect neither your name nor your email address.',
